...
GaussianParticleGenerator::GaussianParticleGenerator(SistemaDeParticulas* s, string name, Particle* p, int n, Vector3 pos, Vector3 v, Vector3 vTip_pos, Vector3 vTip_vel, double rnd, double rndPos)
	: ParticleGenerator(s, name, p, n, pos, v, rnd, rndPos), devTip_pos(vTip_pos), devTip_vel(vTip_vel)
{
